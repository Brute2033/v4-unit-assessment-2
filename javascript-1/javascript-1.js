...
let compareNums = (val1, val2) => (val1 !== val2) ? Math.max(val1, val2) : val2
...
let phone1 = new Phone('Samsung', 'Galaxy Note20 Ultra 5G', 120, 'Mystic Bronze', false)

let phone2 = new Phone('Apple', 'iPhone 11', 0, 'hard to tell', false)

let phone3 = new Phone('google', 'WHAT?', 64, 'only Black', false)
